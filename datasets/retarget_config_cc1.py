...
OUTPUT_DIR = f"{MOTION_FILES_DIR}/mocap_motions_cc1"
...
#     np.array([0, -0.02, 0.0]),  # FL
#     np.array([0, 0.02, 0.0]),   # FR
#     np.array([0, -0.02, 0.0]), # HL
#     np.array([0, 0.02, 0.0]),  # HR
# ]
SIM_TOE_OFFSET_LOCAL = [
    np.array([0, 0.02, 0.0]),  # FL
    np.array([0, -0.02, 0.0]),   # FR
...
# ]
MOCAP_MOTIONS = [
    ["pace0", f"{MOTION_FILES_DIR}/keypoint_datasets/ai4animation/dog_walk00_joint_pos.txt", 162, 201, 1],
    ["pace1", f"{MOTION_FILES_DIR}/keypoint_datasets/ai4animation/dog_walk00_joint_pos.txt", 201, 400, 1],
    ["pace2", f"{MOTION_FILES_DIR}/keypoint_datasets/ai4animation/dog_walk00_joint_pos.txt", 400, 600, 1],
    ["trot0", f"{MOTION_FILES_DIR}/keypoint_datasets/ai4animation/dog_walk03_joint_pos.txt", 448, 481, 1],
    ["trot1", f"{MOTION_FILES_DIR}/keypoint_datasets/ai4animation/dog_walk03_joint_pos.txt", 400, 600, 1],
    ["trot2", f"{MOTION_FILES_DIR}/keypoint_datasets/ai4animation/dog_run04_joint_pos.txt", 480, 663, 1],
    ["canter0", f"{MOTION_FILES_DIR}/keypoint_datasets/ai4animation/dog_run00_joint_pos.txt", 430, 480, 1],
    ["canter1", f"{MOTION_FILES_DIR}/keypoint_datasets/ai4animation/dog_run00_joint_pos.txt", 380, 430, 1],
    ["canter2", f"{MOTION_FILES_DIR}/keypoint_datasets/ai4animation/dog_run00_joint_pos.txt", 480, 566, 1],
    ["right_turn0", f"{MOTION_FILES_DIR}/keypoint_datasets/ai4animation/dog_walk09_joint_pos.txt", 1085, 1124, 1.5],
    ["right_turn1", f"{MOTION_FILES_DIR}/keypoint_datasets/ai4animation/dog_walk09_joint_pos.txt", 560, 670, 1.5],
    ["left_turn0", f"{MOTION_FILES_DIR}/keypoint_datasets/ai4animation/dog_walk09_joint_pos.txt", 2404, 2450, 1.5],
    ["left_turn1", f"{MOTION_FILES_DIR}/keypoint_datasets/ai4animation/dog_walk09_joint_pos.txt", 120, 220, 1.5],
]
